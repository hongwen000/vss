...
class App:
    def __init__(self, root, tray_icon) -> None:
        ...
        self.custom_terms = {"android-kernel-sunfish-msm-4.14-android11-qpr3", "yzy-r743", "r743", "ubuntu", "aosp_host_working_dir", "aosp", "apk", "androidtools", "vss"}  # Add your custom terms here
